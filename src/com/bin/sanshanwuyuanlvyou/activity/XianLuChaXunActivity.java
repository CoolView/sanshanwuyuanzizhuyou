...
public class XianLuChaXunActivity extends Activity implements BaiduMap.OnMapClickListener,
OnGetRoutePlanResultListener {
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(XianLuChaXunActivity.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(XianLuChaXunActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
