...
public class ZhouBianJiaoTongActivity extends FragmentActivity implements
...
if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
	Toast.makeText(ZhouBianJiaoTongActivity.this, "抱歉，未找到结果",
...
Toast.makeText(ZhouBianJiaoTongActivity.this, result.getBusLineName(),
